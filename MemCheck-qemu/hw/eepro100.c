...
{
    return (cu_state_t)((s->mem[SCBStatus] >> 6) & 0x03);
}
...
{
    return (ru_state_t)((s->mem[SCBStatus] >> 2) & 0x0f);
}
...
static void eepro100_cu_command(EEPRO100State * s, uint8_t val)
{
    ...
    case CU_START:
      ...
      next_command:
        ...
        mybool bit_el = ((command & 0x8000) != 0);
        mybool bit_s = ((command & 0x4000) != 0);
        mybool bit_i = ((command & 0x2000) != 0);
        mybool bit_nc = ((command & 0x0010) != 0);
        //~ mybool bit_sf = ((command & 0x0008) != 0);
