...
#define INIT_FIELD(P, V1, V2) { V1, V2 }

CCTable cc_table[CC_OP_NB] = {
    INIT_FIELD(CC_OP_DYNAMIC, NULL, NULL),

    INIT_FIELD(CC_OP_EFLAGS, compute_all_eflags, compute_c_eflags),

    INIT_FIELD(CC_OP_MULB, compute_all_mulb, compute_c_mull),
    INIT_FIELD(CC_OP_MULW, compute_all_mulw, compute_c_mull),
    INIT_FIELD(CC_OP_MULL, compute_all_mull, compute_c_mull),
#ifdef TARGET_X86_64
    INIT_FIELD(CC_OP_MULQ, compute_all_mulq, compute_c_mull),
#else 
    INIT_FIELD(CC_OP_MULQ, NULL, NULL),
#endif

    INIT_FIELD(CC_OP_ADDB, compute_all_addb, compute_c_addb),
    INIT_FIELD(CC_OP_ADDW, compute_all_addw, compute_c_addw),
    INIT_FIELD(CC_OP_ADDL, compute_all_addl, compute_c_addl),
#ifdef TARGET_X86_64
    INIT_FIELD(CC_OP_ADDQ, compute_all_addq, compute_c_addq),
#else
    INIT_FIELD(CC_OP_ADDQ, NULL, NULL),
#endif

    INIT_FIELD(CC_OP_ADCB, compute_all_adcb, compute_c_adcb),
    INIT_FIELD(CC_OP_ADCW, compute_all_adcw, compute_c_adcw),
    INIT_FIELD(CC_OP_ADCL, compute_all_adcl, compute_c_adcl),
#ifdef TARGET_X86_64
    INIT_FIELD(CC_OP_ADCQ, compute_all_adcq, compute_c_adcq),
#else
    INIT_FIELD(CC_OP_ADCQ, NULL, NULL),
#endif

    INIT_FIELD(CC_OP_SUBB, compute_all_subb, compute_c_subb),
    INIT_FIELD(CC_OP_SUBW, compute_all_subw, compute_c_subw),
    INIT_FIELD(CC_OP_SUBL, compute_all_subl, compute_c_subl),
#ifdef TARGET_X86_64
    INIT_FIELD(CC_OP_SUBQ, compute_all_subq, compute_c_subq),
#else
    INIT_FIELD(CC_OP_SUBQ, NULL, NULL),
#endif

    INIT_FIELD(CC_OP_SBBB, compute_all_sbbb, compute_c_sbbb),
    INIT_FIELD(CC_OP_SBBW, compute_all_sbbw, compute_c_sbbw),
    INIT_FIELD(CC_OP_SBBL, compute_all_sbbl, compute_c_sbbl),
#ifdef TARGET_X86_64
    INIT_FIELD(CC_OP_SBBQ, compute_all_sbbq, compute_c_sbbq),
#else
    INIT_FIELD(CC_OP_SBBQ, NULL, NULL),
#endif

    INIT_FIELD(CC_OP_LOGICB, compute_all_logicb, compute_c_logicb),
    INIT_FIELD(CC_OP_LOGICW, compute_all_logicw, compute_c_logicw),
    INIT_FIELD(CC_OP_LOGICL, compute_all_logicl, compute_c_logicl),
#ifdef TARGET_X86_64
    INIT_FIELD(CC_OP_LOGICQ, compute_all_logicq, compute_c_logicq),
#else
    INIT_FIELD(CC_OP_LOGICQ, NULL, NULL),
#endif

    INIT_FIELD(CC_OP_INCB, compute_all_incb, compute_c_incl),
    INIT_FIELD(CC_OP_INCW, compute_all_incw, compute_c_incl),
    INIT_FIELD(CC_OP_INCL, compute_all_incl, compute_c_incl),
#ifdef TARGET_X86_64
    INIT_FIELD(CC_OP_INCQ, compute_all_incq, compute_c_incl),
#else
    INIT_FIELD(CC_OP_INCQ, NULL, NULL),
#endif

    INIT_FIELD(CC_OP_DECB, compute_all_decb, compute_c_incl),
    INIT_FIELD(CC_OP_DECW, compute_all_decw, compute_c_incl),
    INIT_FIELD(CC_OP_DECL, compute_all_decl, compute_c_incl),
#ifdef TARGET_X86_64
    INIT_FIELD(CC_OP_DECQ, compute_all_decq, compute_c_incl),
#else
    INIT_FIELD(CC_OP_DECQ, NULL, NULL),
#endif

    INIT_FIELD(CC_OP_SHLB, compute_all_shlb, compute_c_shlb),
    INIT_FIELD(CC_OP_SHLW, compute_all_shlw, compute_c_shlw),
    INIT_FIELD(CC_OP_SHLL, compute_all_shll, compute_c_shll),
#ifdef TARGET_X86_64
    INIT_FIELD(CC_OP_SHLQ, compute_all_shlq, compute_c_shlq),
#else
    INIT_FIELD(CC_OP_SHLQ, NULL, NULL),
#endif

    INIT_FIELD(CC_OP_SARB, compute_all_sarb, compute_c_sarl),
    INIT_FIELD(CC_OP_SARW, compute_all_sarw, compute_c_sarl),
    INIT_FIELD(CC_OP_SARL, compute_all_sarl, compute_c_sarl),
#ifdef TARGET_X86_64
    INIT_FIELD(CC_OP_SARQ, compute_all_sarq, compute_c_sarl)
#else
    INIT_FIELD(CC_OP_SARQ, NULL, NULL)
#endif
